...
module Merit
  class BadgeRules
    ...
    def initialize
      ...
      grant_on ['products#create','products#update'],  badge: 'eco101', to: :user do |product|
        product.user.organic_recycled_materials < 0.3
      end

      grant_on ['products#create','products#update'],  badge: 'eco102', to: :user do |product|
        product.user.organic_recycled_materials >= 0.3
      end

      grant_on ['products#create','products#update'],  badge: 'eco103', to: :user do |product|
